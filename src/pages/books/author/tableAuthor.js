    ...
    return(
        ...
        <MaterialTable
                ...
                columns={[
                    ...
                    {
                        title: 'Graduação',
                        render: rowData => <div>{RetornarGraduacao(rowData.graduacao_id)}</div>,
                        field: 'graduacao_id',
